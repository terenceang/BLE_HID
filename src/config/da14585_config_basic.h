...
/****************************************************************************************************************/
// #define CFG_DEVELOPMENT_DEBUG    // re-enable for GPIO-reservation checks / hardfault breakpoint while debugging
...
/* will be used.                                                                                                */
/****************************************************************************************************************/
// #define CFG_PRINTF    // re-enable for UART2 debug logging (printk); P0.4, 115200
#ifdef CFG_PRINTF
